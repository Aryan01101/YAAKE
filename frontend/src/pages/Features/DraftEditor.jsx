      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            Edit and refine your resumes and cover letters with our powerful editor featuring real-time suggestions and grammar checks.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="space-y-4 text-gray-600">
              <p className="leading-relaxed">
                A comprehensive editing suite designed specifically for job application documents.
                Polish your content with AI-powered suggestions and professional formatting tools.
              </p>
              <p className="leading-relaxed">
                Collaborate seamlessly, track versions, and ensure your documents are error-free
                with our advanced editing and proofreading capabilities.
              </p>
            </div>
          </div>
              ...
              {[
                ...
                <li key={index} className="flex items-start group">
                  <div className="flex-shrink-0 mt-1">
                    <div className="h-2 w-2 rounded-full bg-blue-600 group-hover:bg-blue-700 transition-colors duration-200"></div>
                  </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl shadow-lg p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Our powerful draft editor with AI assistance is coming soon to help you create
              perfect documents every time.
            </p>
            <button className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
